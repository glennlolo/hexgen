                    ...
                    if self.borders:
                        for e in h.edges:
                            if (
                                e.one.is_owned
                                and e.two.is_owned
                                and e.one.territory.id != e.two.territory.id
                            ):
                    ...
                    if rivers:
                        ...
                        for s in segments:
                            ...
                            if s is HexSide.north_east:
                                ...
                                self.draw.line(
                                    [pointer, pointer_2], river_blue, width=3
                                )
                            elif s is HexSide.south_east:
                                self.draw.line(
                                    [pointer_2, pointer_3], river_blue, width=3
                                )
                            elif s is HexSide.south_west:
                                self.draw.line(
                                    [pointer_3, pointer_4], river_blue, width=3
                                )
                            elif s is HexSide.west:
                                self.draw.line(
                                    [pointer_4, pointer_5], river_blue, width=3
                                )
